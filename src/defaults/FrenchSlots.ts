...
export function getFrenchSlots() {
    ...
    return [
        ...
        new FreeParkingSlot("Parking gratuit", "Le prochain joueur à s'arrêter ici touchera le jackpot.", position++),
        ...
        new GoToJailSlot("Allez en prison", "Allez en prison sans passer par la case Départ.", position++),
