...
export class InitialDataStructures1681212626168 implements MigrationInterface {
    name = 'InitialDataStructures1681212626168'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "message" ("id" SERIAL NOT NULL, "content" text NOT NULL, "boardId" integer, "recipientAccountLogin" character varying, "recipientGameId" integer, "senderAccountLogin" character varying, "senderGameId" integer, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "board" ("id" SERIAL NOT NULL, "jackpot" integer NOT NULL, "salary" integer NOT NULL, CONSTRAINT "PK_865a0f2e22c140d261b1df80eb1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "player" ("accountLogin" character varying NOT NULL, "gameId" integer NOT NULL, "money" integer NOT NULL, "iconStyle" integer NOT NULL, "outOfJailCards" integer NOT NULL, "currentSlotIndex" integer NOT NULL, "inJail" boolean NOT NULL, "isGameMaster" boolean NOT NULL, CONSTRAINT "PK_284f353cf3f93f759ee0c4a8249" PRIMARY KEY ("accountLogin", "gameId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "board_slot" ADD CONSTRAINT "FK_70795ec472b93af2a0e07a08b88" FOREIGN KEY ("ownerAccountLogin", "ownerGameId") REFERENCES "player"("accountLogin","gameId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_12f342292ff7c74f9439659412d" FOREIGN KEY ("recipientAccountLogin", "recipientGameId") REFERENCES "player"("accountLogin","gameId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_216f233ac09ed9858fb2893358f" FOREIGN KEY ("senderAccountLogin", "senderGameId") REFERENCES "player"("accountLogin","gameId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "message" DROP CONSTRAINT "FK_216f233ac09ed9858fb2893358f"`);
        await queryRunner.query(`ALTER TABLE "message" DROP CONSTRAINT "FK_12f342292ff7c74f9439659412d"`);
        ...
        await queryRunner.query(`ALTER TABLE "board_slot" DROP CONSTRAINT "FK_70795ec472b93af2a0e07a08b88"`);
